    ...
    <div className="qp-page">
      <div className="qp-inner">
        ...
        <section className="qp-section qp-print-only qp-unit-print-header">
          <div className="qp-unit-number">
            Unit No: {toTitleCase(unit_no || "-")}
          </div>
        </section>
          ...
          <section className="qp-section qp-print-hide">
            ...
            {payment_plan_detail && (
              <div className="qp-plan-meta">
                Payment Plan:&nbsp;
                <strong>
                  {toTitleCase(payment_plan_detail.name || "")} (
                  {payment_plan_detail.code || ""})
                </strong>
              </div>
            )}
